<?php
// c:\laragon\www\youtube\api\migrate.php
...
<div class="container">
    ...
    <p>This script initializes the new <strong>youtube</strong> database, overhauls data sanitization by removing legacy string escapes (like <code>!1and1!</code> and URL-encoded spaces), and migrates clean records from the legacy database.</p>
